export const PropAMMLaunchPadAbi = [
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct IPropLaunchpad.LaunchConfig",
        components: [
          { name: "token0", type: "address", internalType: "address" },
          { name: "token1", type: "address", internalType: "address" },
          { name: "token0SeedAmt", type: "uint256", internalType: "uint256" },
          { name: "token1SeedAmt", type: "uint256", internalType: "uint256" },
          { name: "strategyAdapter", type: "address", internalType: "address" },
          { name: "thresholdAdapter", type: "address", internalType: "address" },
          { name: "poolName", type: "string", internalType: "string" },
          {
            name: "curatorInfo",
            type: "tuple",
            internalType: "struct IPropLaunchpad.CuratorInfo",
            components: [
  ...
  },
  {
    ...
    outputs: [{ name: "poolId", type: "bytes32", internalType: "PoolId" }],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    name: "propHook",
    inputs: [],
    outputs: [{ name: "", type: "address", internalType: "contract IPropHook" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    type: "function",
    name: "setPropHook",
    inputs: [{ name: "_propHook", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
